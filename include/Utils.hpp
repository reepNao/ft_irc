...
{
	/*
	error.log dosyasına hata mesajlarını yazdırır
	__TIME__: hata zamanı
	fileInfo: hata alınan dosya
	lineInfo: hata alınan satır
	messageInfo: hata mesajı
	isFatal: hata kritik mi değil mi
	*/
	ofstream errorLog;
